...
DefensiveData.ALL_DEFENSIVES = {
    ...
    [31821]  = { name = "Aura Mastery",        cd = 180, duration = 8,  category = "party",    class = "PALADIN" },
    [201633] = { name = "Earthen Wall Totem",  cd = 60,  duration = 15, category = "party",    class = "SHAMAN" },
    [8178]   = { name = "Grounding Totem",     cd = 24,  duration = 3,  category = "party",    class = "SHAMAN" },
    ...
    [357170] = { name = "Time Dilation",          cd = 60,  duration = 8,  category = "external", class = "EVOKER" },
    [204018] = { name = "Blessing of Spellwarding", cd = 300, duration = 10, category = "external", class = "PALADIN" },
    [197268] = { name = "Ray of Hope",            cd = 90,  duration = 6,  category = "external", class = "PRIEST" },
    [3411]   = { name = "Intervene",              cd = 30,  duration = 6,  category = "external", class = "WARRIOR" },
    ...
    [49028]  = { name = "Dancing Rune Weapon",  cd = 90,  duration = 8,  category = "major",    class = "DEATHKNIGHT" },
    [55233]  = { name = "Vampiric Blood",       cd = 120, duration = 10, category = "major",    class = "DEATHKNIGHT" },
    [196555] = { name = "Netherwalk",           cd = 180, duration = 6,  category = "major",    class = "DEMONHUNTER" },
    [200851] = { name = "Rage of the Sleeper",  cd = 120, duration = 8,  category = "major",    class = "DRUID" },
    [102558] = { name = "Incarnation: Guardian of Ursoc", cd = 180, duration = 30, category = "major", class = "DRUID" },
    [370960] = { name = "Emerald Communion",    cd = 180, duration = 5,  category = "major",    class = "EVOKER" },
    ...
    [125174] = { name = "Touch of Karma",       cd = 90,  duration = 10, category = "major",    class = "MONK" },
    [31850]  = { name = "Ardent Defender",      cd = 120, duration = 8,  category = "major",    class = "PALADIN" },
    [212641] = { name = "Guardian of Ancient Kings", cd = 300, duration = 8, category = "major", class = "PALADIN" },
    [184662] = { name = "Shield of Vengeance",  cd = 120, duration = 15, category = "major",    class = "PALADIN" },
    [114893] = { name = "Stone Bulwark Totem",  cd = 120, duration = 30, category = "major",    class = "SHAMAN" },
    [108416] = { name = "Dark Pact",            cd = 60,  duration = 20, category = "major",    class = "WARLOCK" },
    [12975]  = { name = "Last Stand",           cd = 120, duration = 15, category = "major",    class = "WARRIOR" },
    ...
    [194679] = { name = "Rune Tap",             cd = 25,  duration = 4,  category = "personal", class = "DEATHKNIGHT" },
    [22842]  = { name = "Frenzied Regeneration", cd = 36, duration = 3,  category = "personal", class = "DRUID" },
    [374348] = { name = "Renewing Blaze",       cd = 90,  duration = 8,  category = "personal", class = "EVOKER" },
    [122278] = { name = "Dampen Harm",          cd = 120, duration = 10, category = "personal", class = "MONK" },
    [498]    = { name = "Divine Protection",    cd = 60,  duration = 8,  category = "personal", class = "PALADIN" },
    [205191] = { name = "Eye for an Eye",       cd = 45,  duration = 10, category = "personal", class = "PALADIN" },
    [389539] = { name = "Sentinel",             cd = 120, duration = 12, category = "personal", class = "PALADIN" },
    [19236]  = { name = "Desperate Prayer",     cd = 90,  duration = 10, category = "personal", class = "PRIEST" },
    [586]    = { name = "Fade",                 cd = 20,  duration = 10, category = "personal", class = "PRIEST" },
    [23920]  = { name = "Spell Reflection",     cd = 25,  duration = 5,  category = "personal", class = "WARRIOR" },
}
