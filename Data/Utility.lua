...
D.capabilities.offensive_dispel = {
    ...
    providers = {
        ...
        },
        {
            ...
            note      = "Removes 1 Enrage and 1 Magic effect from an enemy.",
            icon      = 136020,
            rangeText = "Long",
            castTimeMS = 0,
            cooldownMS = 10000,
...
D.capabilities.soothe = {
    ...
    providers = {
        ...
        },
        {
            ...
            spellID   = 19801,
            spellName = "Tranquilizing Shot",
            note      = "Removes 1 Enrage and 1 Magic effect. 10 sec CD.",
            icon      = 136020,
            rangeText = "Long",
            castTimeMS = 0,
            cooldownMS = 10000,
        ...
        },
        {
            ...
            spellID   = 5938,
            spellName = "Shiv",
            note      = "Applies concentrated poison which can remove Enrage when using specific poisons.",
            icon      = 135428,
            rangeText = "Combat",
            castTimeMS = 0,
            cooldownMS = 1000,
